            ...
            <table class="table table-striped projects">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                             <?php
                          echo  $_SESSION['vall_ticket'][$i];
                           ?>
                        </td>
                        <td>
                            <a>
                                 <?php
                               echo  $_SESSION['vall_ticket'][$i+1];
                                ?>
                            </a>
                        ...
                        <td class="project-state">
                            <span class="badge badge-success"> <?php
                               echo  $_SESSION['vall_ticket'][$i+2];
                                ?></span>
                        </td>
                       <td class="project-actions text-center">
                            <button class="btn btn-primary btn-sm" name="ticket_title" value= "<?php echo $_SESSION['vall_ticket'][$i+1] ; ?>">

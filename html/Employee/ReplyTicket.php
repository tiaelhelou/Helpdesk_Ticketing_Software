...
$query = $mysqli->prepare("SELECT id_ticket FROM tickets WHERE ticket_title = ? and id_employee = ?;");
...
$query = $mysqli->prepare(
						  "INSERT INTO employee_replies (id_employee_replie, ticket_reply, tickets_id_ticket, employess_id_employee)
						   VALUES (?, ?, ?,?)";
						 );
